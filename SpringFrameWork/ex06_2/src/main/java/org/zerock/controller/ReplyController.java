...
public class ReplyController {
	 ...
	 * create(@RequestBody ReplyVO vo){ log.info("ReplyVO"+vo); int insertCount =
	 * service.register(vo); log.info("Reply INSERT COUNT : "+ insertCount);
	 * 
	 ...
	 * 
	 * @PathVariable("bno") Long bno){ Criteria cri = new Criteria(page,10);
	 * log.info("get Reply List bno : " + bno); log.info("cri : " + cri); return new
	 ...
	 * service.modify(vo)==1 ? new ResponseEntity<>("success",HttpStatus.OK) : new
	 * ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR); }
	 */
